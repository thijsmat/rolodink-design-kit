      ...
      <div className="max-w-[1136px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-white border border-azure/10 rounded-2xl p-8 relative">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-azure truncate">{testimonial.name}</h3>
                  <p className="text-sm text-grey truncate">{testimonial.role}</p>
