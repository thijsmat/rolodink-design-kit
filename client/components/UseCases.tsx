const useCases = [
  ...
  },
  {
    icon: (
      ...
      >
        <path
          d="M21.42 10.9219C21.599 10.8429 21.7509 10.7131 21.8569 10.5487C21.9629 10.3842 22.0183 10.1923 22.0163 9.99661C22.0143 9.80095 21.9549 9.61019 21.8455 9.44795C21.7362 9.28571 21.5816 9.15912 21.401 9.08387L12.83 5.17987C12.5694 5.06102 12.2864 4.99951 12 4.99951C11.7136 4.99951 11.4305 5.06102 11.17 5.17987L2.59998 9.07987C2.42195 9.15784 2.2705 9.286 2.16415 9.44868C2.0578 9.61136 2.00116 9.80151 2.00116 9.99587C2.00116 10.1902 2.0578 10.3804 2.16415 10.5431C2.2705 10.7057 2.42195 10.8339 2.59998 10.9119L11.17 14.8199C11.4305 14.9387 11.7136 15.0002 12 15.0002C12.2864 15.0002 12.5694 14.9387 12.83 14.8199L21.42 10.9219Z"
          stroke="#B8860B"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
...
export default function UseCases() {
  return (
    <section className="py-12 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent to-[rgba(245,245,245,0.3)]">
      <div className="max-w-[1136px] mx-auto">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-grey max-w-[672px] mx-auto px-4 sm:px-0">
            Rolodink helpt professionals in verschillende sectoren om hun
            netwerk effectiever te beheren.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
          {useCases.map((useCase, index) => (
            <div
              key={index}
              className="bg-white border border-azure/10 rounded-lg sm:rounded-2xl p-4 sm:p-6 text-center"
            >
              <div className="w-10 sm:w-12 h-10 sm:h-12 rounded-full bg-gold/10 flex items-center justify-center mx-auto mb-2 sm:mb-4">
                {useCase.icon}
              </div>
              <h3 className="font-semibold text-azure mb-1 sm:mb-2 text-sm sm:text-base">
                {useCase.title}
              </h3>
