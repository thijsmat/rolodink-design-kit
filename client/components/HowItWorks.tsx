        ...
        <div className="max-w-[768px] mx-auto">
            ...
            <div className="border-b border-azure/10 pb-4 sm:pb-6 mb-4 sm:mb-6">
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="w-12 sm:w-20 h-12 sm:h-20 rounded-full bg-gradient-to-br from-linkBlue to-linkBlue/80 flex items-center justify-center flex-shrink-0">
                  <span className="text-white font-semibold text-sm sm:text-2xl">
                    SvB
                  </span>
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-base sm:text-2xl text-azure mb-1 truncate">
                    Sarah van Berg
                  </h3>
                  <p className="text-xs sm:text-base text-grey mb-2 truncate">
                    Senior Recruiter @ TalentHub
                  </p>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4 gap-2">
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <h4 className="font-semibold text-azure text-xs sm:text-base truncate">
                    Rolodink Notities
                  </h4>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mt-6 sm:mt-8">
            <div className="text-center">
              ...
              <h5 className="font-semibold text-xs sm:text-sm text-azure mb-1">
                Eenvoudig bewerken
              </h5>
