        ...
        <div className="max-w-[768px] mx-auto">
            ...
            <div className="border-b border-azure/10 pb-6 mb-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-2xl text-azure mb-1">Sarah van Berg</h3>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-semibold text-azure">Rolodink Notities</h4>
                </div>
          ...
          <div className="grid grid-cols-3 gap-4 mt-8">
            <div className="text-center">
              ...
              <h5 className="font-semibold text-sm text-azure mb-1">Eenvoudig bewerken</h5>
            ...
            <div className="text-center">
              ...
              <h5 className="font-semibold text-sm text-azure mb-1">Automatisch opslaan</h5>
            ...
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-linkBlue/10 flex items-center justify-center mx-auto mb-3">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M4 6C5.10457 6 6 5.10457 6 4C6 2.89543 5.10457 2 4 2C2.89543 2 2 2.89543 2 4C2 5.10457 2.89543 6 4 6Z" stroke="#0066CC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <h5 className="font-semibold text-sm text-azure mb-1">LinkedIn integratie</h5>
