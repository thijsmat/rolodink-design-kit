    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[rgba(247,245,240,0.95)] backdrop-blur-sm border-b border-azure/10">
      <div className="max-w-[1136px] mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="font-playfair font-semibold text-lg sm:text-xl text-azure truncate">
            Rolodink
          </span>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3 lg:gap-4">
          <a
            href="#features"
            className="hidden sm:inline text-xs sm:text-sm text-azure hover:text-azure/80 transition-colors"
          >
            Features
          </a>
          <a
